...
parser.add_argument(
    "--base_dir",
    type=str,
    default='C:/Users/A_J_F/Documents/TESS_ExoFinder/data',
    help="Directory where text file(s) of TCE lists are located.")
...
for bad_list in bad_lists:
    ...
    new_dataframe['Disposition'] = 0
    bad_tces = pd.concat([bad_tces, new_dataframe], ignore_index=True)

bad_tces.to_csv(os.path.join(FLAGS.save_dir,'empty_catalog.csv'), index=False)